...
class ClusterViewSet(viewsets.ModelViewSet):
    ...
    def get_pipeline_status(self, request):
        ...
        print(f'clusterName=hdasdhasgdjgasjdgjasgjdasgjdgj {clusterName}')
...
def trigger_single(base_url, project_id, headers, branch_name):
    ...
    while pipeline_status in ["pending", "running"]:
        ...
        pipeline_info_response = requests.get(base_url + f"projects/{project_id}/pipelines/{pipeline_id}", headers=headers, verify=False)
